...
class CustomerProfileController: BaseViewController,UITableViewDelegate, UITableViewDataSource ,ExpandableLabelDelegate{
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        self.title = "Thông tin tuyển dụng"
        self.viewModel.loadCustomerProfile(success: { getCustomerProfile in
            ...
            self.tableviewImage.estimatedRowHeight = 76
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        if indexPath.row == 6 {
            ...
            cell?.expandableLabel.text = arrContent[indexPath.row]
            ...
            let myVideoURL = NSURL(string: StringUtils.shared.checkEmpty(value: self.profileCustomer!.videoLink))
