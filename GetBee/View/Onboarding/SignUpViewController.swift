...
class SignUpViewController: BaseViewController, UITextFieldDelegate {
    ...
    func textFieldDidBeginEditing(_ textField: UITextField) {
        ...
        verticalUser.layer.backgroundColor = textField == textFieldFullname.self ? StringUtils.hexStringToUIColor(hex: "#FFD215").cgColor : StringUtils.hexStringToUIColor(hex: "#D2D2E1").cgColor
        ...
        verticalPhone.layer.backgroundColor = textField == textFieldPhone.self ? StringUtils.hexStringToUIColor(hex: "#FFD215").cgColor : StringUtils.hexStringToUIColor(hex: "#D2D2E1").cgColor
    }
    ...
    @IBAction func tapOnSignUpButton(_ sender: Any) {
        ...
        if fullname.count == 0 && email.count == 0 && phone.count == 0 {
            ...
            textFieldFullname.attributedPlaceholder = NSAttributedString(string: NSLocalizedString("input_name", comment: ""), attributes: [NSAttributedString.Key.foregroundColor: StringUtils.hexStringToUIColor(hex: "#DC4444")])
            ...
            viewModel.signup(email: self.textFieldEmail.text!, address: "", carrer: self.jobTextField.text!, fullName: self.textFieldFullname.text!, phone: self.textFieldPhone.text!,companyName: StringUtils.checkEmpty(value: self.textFieldCompanyName.text),mType: 7,contact: "",birthday: self.somedateString2 , success: {
                self.animateIn()
            }, failure: {error in
